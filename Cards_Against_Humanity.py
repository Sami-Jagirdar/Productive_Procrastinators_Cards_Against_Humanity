...
def actual_game(pn,prompts,prompt_answers):
    ...
    for e in range(0, pn):
        print("Player {}, you are the prompt holder. Here is your prompt: ".format(e+1))
        temp_answers = []
        temp2 = randint(0,y-1)
        y = y - 1
        ...
        funniest_answer = int(input("Player {}, Which player had the funniest answer? : ".format(e+1)))
        print()
        points[funniest_answer-1] += 1
